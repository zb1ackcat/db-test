...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (isset($_POST['distance'], $_POST['gallon_price'], $_POST['efficiency']) &&
	 ...
	 is_numeric($_POST['efficiency']) ) {
		...
		$_POST['gallon_price'] . ' per gallon, is $' . number_format($dollars, 2) . '. If you 
		drive at an average of 65 miles per hour, the trip will take approximately ' . 
...
<form action="calculator.php" method="post">
	...
	<p>Ave. Price Per Gallon:
		...
		(isset($_POST['gallon_price']) && ($_POST['gallon_price'] == '3.50')) echo 
		'checked="checked" '; ?>> 3.50
